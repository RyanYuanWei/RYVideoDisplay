...
//    _barView.backgroundColor = RGB_COLOR_ALPHA(43, 42, 55, 1);
    _barView.backgroundColor = [UIColor colorWithWhite:0 alpha:0.1];
    [self addSubview:_barView];
    
    //最短分割线
//     UIView *intervalView = [[UIView alloc] initWithFrame:CGRectMake(self.frame.size.width / MaxDuration  * MinDuration, 0, 1, _barHeight)];
    UIView *intervalView = [[UIView alloc] initWithFrame:CGRectMake(self.frame.size.width / 60  * 60, 0, 1, _barHeight)];
...
//    progressView.backgroundColor = [XKColor XKFCE76C];
    progressView.autoresizesSubviews = YES;
//    [progressView showBorderSite:rzBorderSitePlaceRight];
//    progressView.rightBorder.borderLine.backgroundColor = [UIColor colorWithWhite:0 alpha:0.1];;
//    progressView.rightBorder.rightMargin = -1;
    return progressView;
}
